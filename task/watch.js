...
module.exports = function () { // eslint-disable-line func-names
  ...
  themes.forEach(name => {
    ...
    if (!theme.localeOverwrites) {
      plugins
        .util
        .log(plugins.util.colors.green('Watching theme:') + ' ' + plugins.util.colors.blue(name) + ' ' + plugins.util.colors.green('Locale:') + ' ' + plugins.util.colors.blue(theme.locale.join(' ')) + ' ' + plugins.util.colors.green('and dependencies...'));
      ...
      files.forEach(file => {
        ...
        gulp.watch(Array.from(dependencies), event => {
          plugins
            .util
            .log(plugins.util.colors.green('File') + ' ' + plugins.util.colors.blue(event.path.replace(config.tempPath, '')) + ' ' + plugins.util.colors.green('changed.'));
      ...
      theme
        ...
        .forEach(locale => {
          plugins
            .util
            .log(plugins.util.colors.green('Watching theme:') + ' ' + plugins.util.colors.blue(name) + ' ' + plugins.util.colors.green('Locale:') + ' ' + plugins.util.colors.blue(locale) + ' ' + plugins.util.colors.green('and dependencies...'));
